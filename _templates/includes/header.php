...
<!--[if gt IE 9]><!--><html class="no-js"><!--<![endif]-->
    ...
    <head>
        ...
        <meta name="description" content="One page application that aggigates news to your preference and tells the weather">
        ...
        <meta property="og:description" content="One page application that aggigates news to your preference and tells the weather">
        ...
        <meta name="twitter:description" content="One page application that aggigates news to your preference and tells the weather"/>
